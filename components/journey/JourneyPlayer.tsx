    ...
    <motion.div layoutId="panelContent" className={panelBaseClasses}>
      ...
      <div className="flex flex-wrap gap-3 justify-between items-center mb-4">
        <button
          ...
          className="w-11 h-11 rounded-full border border-[rgba(13,15,18,0.1)] flex items-center justify-center text-[var(--text-2)] disabled:opacity-40 disabled:cursor-not-allowed hover:bg-black/[0.03]"
          title="Previous ayah"
        >
      ...
      <div className="flex flex-wrap justify-center gap-3 mb-8">
        <button
          type="button"
          className="inline-flex items-center gap-2 rounded-full border border-[rgba(13,15,18,0.12)] px-4 py-2 text-xs font-sans font-medium text-[var(--text-2)] hover:bg-black/[0.03] disabled:opacity-35 disabled:pointer-events-none"
