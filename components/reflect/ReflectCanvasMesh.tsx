...
export default function ReflectCanvasMesh() {
  ...
  useEffect(() => {
    ...
    const blobs = [{ r: 350, color: "rgba(42,107,94,0.18)", speed: 0.001, t: 0 },{ r: 280, color: "rgba(184,148,63,0.12)", speed: 0.0015, t: 100 },{ r: 400, color: "rgba(8,10,14,0.9)", speed: 0.0008, t: 50 },{ r: 250, color: "rgba(30,41,59,0.4)", speed: 0.0012, t: 200 }];
